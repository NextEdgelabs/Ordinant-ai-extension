...
Custom Modes let you create tailored versions of Ordinant.ai's built-in [modes](/basic-usage/using-modes) for your organization. You can also adjust the settings for Ordinant.ai's original default modes. You can define a mode’s purpose, behavior, and tool access — helping Ordinant.ai adapt to your team’s unique workflows.
...
| **Role Definition**                | Describe Ordinant.ai's role and personality for this mode. Shapes how it reasons and responds.       |
