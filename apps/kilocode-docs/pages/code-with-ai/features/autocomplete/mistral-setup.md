...
This guide walks you through setting up Mistral's Codestral model for free autocomplete in Ordinant.ai. Mistral offers a free tier that's perfect for getting started with AI-powered code completions.

## Video Walkthrough

{% youtube url="https://www.youtube.com/embed/0aqBbB8fPho" caption="Setting up Mistral for free autocomplete in Ordinant.ai" /%}

## Step 1: Open Ordinant.ai Settings

In VS Code, open the Ordinant.ai panel and click the **Settings** icon (gear) in the top-right corner.

![Open Ordinant.ai Settings](/docs/img/mistral-setup/01-open-kilo-code-settings.png)
...
:::note
When creating an autocomplete profile, you don't need to select a specific model—Ordinant.ai will automatically use the appropriate Codestral model optimized for code completions.
:::
...
## Step 9: Paste API Key in Ordinant.ai

Return to Ordinant.ai settings and paste your API key into the **Mistral API Key** field.
