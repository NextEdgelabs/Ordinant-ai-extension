...
Ordinant.ai implements the Model Context Protocol to:
...
- [Using MCP in Ordinant.ai](/features/mcp/using-mcp-in-kilo-code) - Get started with MCP in Ordinant.ai, including creating simple servers
