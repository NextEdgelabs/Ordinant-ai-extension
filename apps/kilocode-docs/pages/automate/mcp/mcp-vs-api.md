...
## Why Ordinant.ai Uses MCP

Ordinant.ai leverages MCP to provide:
...
MCP creates a universal connector between Ordinant.ai and external services, with REST APIs often powering those services behind the scenes.
