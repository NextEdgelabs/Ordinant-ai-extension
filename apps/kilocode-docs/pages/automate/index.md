---
title: "Automate"
description: "Automate your development workflows with Ordinant.ai"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Ordinant.ai's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Ordinant.ai to external tools and services:
...
- [**Using MCP in Ordinant.ai**](/docs/automate/mcp/using-in-kilo-code) — Configuration guide
...
Connect Ordinant.ai with your development tools:
...
## Extending Ordinant.ai

Customize and extend Ordinant.ai's capabilities:
