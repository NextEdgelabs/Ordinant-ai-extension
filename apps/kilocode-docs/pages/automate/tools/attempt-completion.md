...
The `attempt_completion` tool signals that Ordinant.ai believes a task is complete and presents results to the user. It provides a summary of what was accomplished, optionally includes a command to demonstrate the result, and supports continued refinement through user feedback.
...
- When Ordinant.ai believes the user's task has been completed
...
- Provides a clear signal that Ordinant.ai believes the task is complete
...
- Feedback is processed and returned to Ordinant.ai for further refinements
...
- When creating a website, Ordinant.ai presents the solution and uses `open index.html` to show the result. The user provides feedback, and Ordinant.ai refines the design.
- When implementing a feature, Ordinant.ai summarizes the changes and their impact. The user requests additional test coverage, and Ordinant.ai continues the task.
- When fixing bugs, Ordinant.ai explains what was fixed and how the solution addresses the Ordinant.ait cause. The user confirms the fix works.
- When setting up a development environment, Ordinant.ai confirms all components are installed. The user requests additional configuration, and Ordinant.ai continues.
- When creating a data processing script, Ordinant.ai summarizes the functionality. The user suggests performance improvements, and Ordinant.ai optimizes the code.
