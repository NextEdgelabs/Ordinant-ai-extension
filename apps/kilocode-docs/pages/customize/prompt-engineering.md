...
Prompt engineering is the art of crafting effective instructions for AI models like Ordinant.ai. Well-written prompts lead to better results, fewer errors, and a more efficient workflow.

## General Principles

- **Be Clear and Specific:** Clearly state what you want Ordinant.ai to do. Avoid ambiguity.
...
It's often helpful to guide Ordinant.ai through a "think-then-do" process:

1.  **Analyze:** Ask Ordinant.ai to analyze the current code, identify problems, or plan the approach.
2.  **Plan:** Have Ordinant.ai outline the steps it will take to complete the task.
3.  **Execute:** Instruct Ordinant.ai to implement the plan, one step at a time.
4.  **Review:** Carefully review the results of each step before proceeding.

## Using Custom Instructions

You can provide custom instructions to further tailor Ordinant.ai's behavior. There are two types of custom instructions:
...
- Adjust Ordinant.ai's tone or personality.

See the [Custom Instructions](/agent-behavior/custom-instructions) section for more details.

## Handling Ambiguity

If your request is ambiguous or lacks sufficient detail, Ordinant.ai might:
...
If Ordinant.ai doesn't produce the desired results, you can provide feedback by:

- **Rejecting Actions:** Click the "Reject" button when Ordinant.ai proposes an action you don't want.
- **Providing Explanations:** When rejecting, explain _why_ you're rejecting the action. This helps Ordinant.ai learn from its mistakes.
...
By following these tips, you can write effective prompts that get the most out of Ordinant.ai's capabilities.
