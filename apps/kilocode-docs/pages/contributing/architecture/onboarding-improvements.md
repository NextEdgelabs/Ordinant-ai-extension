...
Users aren't guided through Ordinant.ai's modes or key features. The existing tab-based tutorial is easily dismissed, causing users to miss critical functionality.
...
├── Content: "Welcome to Ordinant.ai! Let's take a quick tour."
...
## Ordinant.ai Provider Settings UI Improvements

The "Set API Key" button is at the bottom of settings, making Ordinant.ai setup hard to discover and complete.

**Improvements:**

- Move "Set API Key" button next to API key input field
- Rearrange layout for better flow
- Make Ordinant.ai provider setup prominent
...
- Integration with Ordinant.ai teams for company/repo-personalized onboarding
