---
title: Fireworks AI with Ordinant.ai
---

# Using Fireworks AI With Ordinant.ai
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Ordinant.ai").
