...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Ordinant.ai's enterprise solution."
			: "Fill out the form below to see Ordinant.ai's enterprise capabilities in action."
