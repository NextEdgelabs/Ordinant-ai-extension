...
const API_URL = "https://api.ordinant.ai/proxy/v1/models?include_paid=true"
...
const faqs = [
	...
	{
		question: "What is the Ordinant.ai Router?",
		answer: (
			<>
				<p>This is our very own model router, optimized to work seamlessly with Ordinant.ai Cloud.</p>
				<p>You don&apos;t have to use it to use Ordinant.ai, but it&apos;s the easiest way to do it.</p>
			</>
		),
	},
	{
		question: "Do I have to use the Ordinant.ai Router to use the Ordinant.ai products?",
	...
	},
	{
		...
		answer: "The Ordinant.ai Router doesn't keep any of your data, the service only aims to make it easier to use Ordinant.ai. Each model vendor has their own privacy policy though, and usually free models use your data for training, so keep that in mind.",
	},
	{
		question: "How much does the Ordinant.ai Cloud service cost?",
		answer: (
			<>
				Our{" "}
			...
			<section className="relative overflow-hidden py-16">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-4xl md:text-5xl font-bold tracking-tight">The Ordinant.ai Router</h1>
						<p className="mx-auto mt-4 max-w-3xl md:text-lg text-muted-foreground">
							The easiest way to use Ordinant.ai (in the{" "}
