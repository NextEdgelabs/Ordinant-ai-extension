...
const TITLE = "Ordinant.ai Pricing"
const DESCRIPTION =
	"Simple, transparent pricing for all Ordinant.ai products. The VS Code extension is free forever. Choose the cloud plan that fits your needs."
...
const pricingTiers: PricingTier[] = [
	...
	},
	{
		...
		features: [
			...
			"Access to the Ordinant.ai Router",
			...
			<section className="relative overflow-hidden pt-12 pb-10">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-5xl font-bold tracking-tight">Ordinant.ai Pricing</h1>
						<p className="mt-4 text-lg text-muted-foreground">
							For all of our products: the Ordinant.ai VS Code Extension, Ordinant.ai Cloud and the
							Ordinant.ai Router.
						</p>
					</div>
				</div>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="max-w-6xl mx-auto mt-8 p-7 flex flex-col md:flex-row gap-8 md:gap-4 bg-violet-200/20 outline-violet-700/20 outline outline-1 rounded-2xl transition-all shadow-none">
						<div className="md:border-r md:pr-4">
							<h3 className="text-lg font-medium mb-1">Ordinant.ai Router</h3>
							<div className="text-sm text-muted-foreground">
								<p className="">
									On any plan, you can use your own LLM provider API key or use the built-in
									Ordinant.ai Router – curated models to work with Ordinant.ai with no markup,
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
						<div className="rounded-xl border border-border bg-card p-6">
							<h3 className="font-semibold">Wait, is Ordinant.ai free or not?</h3>
							<p className="mt-2 text-sm text-muted-foreground">
								Yes! The Ordinant.ai VS Code extension is open source and free forever. The extension
						...
						<div className="rounded-xl border border-border bg-card p-6">
							...
							<p className="mt-2 text-sm text-muted-foreground">
								Ordinant.ai Cloud credits can be used in two ways:
							</p>
							<ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground">
								...
								<li>
									...
									<a
										href="https://app.ordinant.ai/provider/pricing"
										target="_blank"
