...
export const AUTH_BASE_URL = process.env.ROO_AUTH_BASE_URL ?? "https://app.ordinant.ai"

export const SDK_BASE_URL = process.env.ROO_SDK_BASE_URL ?? "https://cloud-api.ordinant.ai"
