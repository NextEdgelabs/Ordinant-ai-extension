...
const initWorkspaceRepo = async ({
	workspaceDir,
	userName = "Ordinant.ai",
	userEmail = "support@ordinant.ai",
	...
	(klass, prefix) => {
		...
		describe(`${klass.name}#hasNestedGitRepositories`, () => {
			it("throws error when nested git repositories are detected during initialization", async () => {
				...
				await mainGit.init()
				await mainGit.addConfig("user.name", "Ordinant.ai")
				await mainGit.addConfig("user.email", "support@ordinant.ai")
				...
				await nestedGit.addConfig("user.name", "Ordinant.ai")
				await nestedGit.addConfig("user.email", "support@ordinant.ai")
