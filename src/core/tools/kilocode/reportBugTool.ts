	...
	try {
		if (block.partial) {
			...
			const kilocodeVersion =
				vscode.extensions.getExtension("ordinant-ai.ordinant-ai")?.packageJSON.version || "Unknown"
			...
			if (text || images?.length) {
				...
				try {
					...
					await createAndOpenGitHubIssue("Ordinant-ai", "ordinant-ai-extension", "bug_report.yml", params)
				} catch (error) {
