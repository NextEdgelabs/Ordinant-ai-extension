	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				"chat:slashCommand.wantsToRun": "Ordinant.ai wants to run slash command:",
				"chat:slashCommand.didRun": "Ordinant.ai ran slash command:",
			}
...
describe("ChatRow - runSlashCommand tool", () => {
	...
	it("should display runSlashCommand ask message with command only", () => {
		...
		expect(getByText("Ordinant.ai wants to run slash command:")).toBeInTheDocument()
	...
	it("should display runSlashCommand say message", () => {
		...
		expect(getByText("Ordinant.ai ran slash command:")).toBeInTheDocument()
