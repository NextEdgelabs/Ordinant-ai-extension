...
You can find your Ordinant.ai API token on your profile page at [app.ordinant.ai](https://app.ordinant.ai), and place it in the `kilocodeToken` field in the CLI config.
