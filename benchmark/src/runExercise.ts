...
export async function run() {
	...
	const extension = vscode.extensions.getExtension<RooCodeAPI>("ordinant-ai.Ordinant-AI")
	...
	/**
	 * Wait for Ordinant.ai to be ready to accept tasks.
	 */

	await waitUntilReady({ api })

	/**
	 * Configure Ordinant.ai as needed.
	 *
