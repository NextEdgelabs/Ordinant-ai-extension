...
describe("URL functions", () => {
	...
	describe("getExtensionConfigUrl", () => {
		...
		it("should use subdomain structure for production", () => {
			expect(getExtensionConfigUrl()).toBe("https://api.ordinant.ai/extension-config.json")
		})
	...
	describe("getApiUrl", () => {
		it("should handle production URLs with api subdomain", () => {
			expect(getApiUrl()).toBe("https://api.ordinant.ai/")
			expect(getApiUrl("/trpc/cliSessions.get")).toBe("https://api.ordinant.ai/trpc/cliSessions.get")
			expect(getApiUrl("/api/profile")).toBe("https://api.ordinant.ai/api/profile")
		})
	...
	describe("getAppUrl", () => {
		it("should handle production URLs correctly", () => {
			expect(getAppUrl()).toBe("https://ordinant.ai/")
			expect(getAppUrl("/profile")).toBe("https://ordinant.ai/profile")
			expect(getAppUrl("/support")).toBe("https://ordinant.ai/support")
			expect(getAppUrl("/sign-in-to-editor")).toBe("https://ordinant.ai/sign-in-to-editor")
			expect(getAppUrl("/sign-in-to-editor?source=vscode")).toBe(
				"https://ordinant.ai/sign-in-to-editor?source=vscode",
			)
		})
	...
	describe("getKiloUrlFromToken", () => {
		it("should handle production token URLs correctly", () => {
			...
			// Token-based URLs using api.ordinant.ai subdomain
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/profile", prodToken)).toBe(
				"https://api.ordinant.ai/api/profile",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/profile/balance", prodToken)).toBe(
				"https://api.ordinant.ai/api/profile/balance",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/organizations/123/defaults", prodToken)).toBe(
				"https://api.ordinant.ai/api/organizations/123/defaults",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/openrouter/", prodToken)).toBe(
				"https://api.ordinant.ai/api/openrouter/",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/users/notifications", prodToken)).toBe(
				"https://api.ordinant.ai/api/users/notifications",
			)
		})
		...
		it("should map development tokens to localhost correctly", () => {
			...
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/profile", devToken)).toBe(
				"http://localhost:3000/api/profile",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/profile/balance", devToken)).toBe(
				"http://localhost:3000/api/profile/balance",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/organizations/456/defaults", devToken)).toBe(
				"http://localhost:3000/api/organizations/456/defaults",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/openrouter/", devToken)).toBe(
				"http://localhost:3000/api/openrouter/",
			)
			expect(getKiloUrlFromToken("https://api.ordinant.ai/api/users/notifications", devToken)).toBe(
		...
		it("should handle invalid tokens gracefully", () => {
			...
			const result = getKiloUrlFromToken("https://api.ordinant.ai/api/test", "header.invalid-json.signature")
			expect(result).toBe("https://api.ordinant.ai/api/test")
	...
	describe("Real-world URL patterns from application", () => {
		it("should correctly handle marketplace endpoints", () => {
			...
			expect(getAppUrl("/api/marketplace/modes")).toBe("https://ordinant.ai/api/marketplace/modes")
			expect(getAppUrl("/api/marketplace/mcps")).toBe("https://ordinant.ai/api/marketplace/mcps")
		})
		...
		it("should maintain backwards compatibility for legacy endpoints", () => {
			expect(getExtensionConfigUrl()).toBe("https://api.ordinant.ai/extension-config.json")
			expect(getAppUrl("/api/extension-config.json")).toBe("https://ordinant.ai/api/extension-config.json")
